...
const Button = ({ buttonName }: ButtonName) => {
  return (
    ...
    // </div>
    <>
      <button className=" text-xl font-medium text-amber-400 border-2 border-[#66230e] px-12 py-2 rounded-full hover:text-white hover:text-center group relative flex items-center text-center overflow-hidden indent-0">
