...
const Features = () => {
  return (
    <div>
      <h1 className="text-4xl">thsi is feature ui componenet</h1>
    </div>
  );
};
...
const trainers: Trainer[] = [
  {
    ...
    reviews: [
      { clientName: "Alice", feedback: "Great trainer, very knowledgeable!", rating: 5 },
      { clientName: "Bob", feedback: "Helped me achieve my goals.", rating: 4.5 },
    ],
    profilePicture: "/images/john-doe.jpg",
  },
  {
    name: "Jane Smith",
    ...
    reviews: [
      ...
      { clientName: "Liam", feedback: "Relaxing and professional.", rating: 4.8 },
    ],
    profilePicture: "/images/jane-smith.jpg",
  },
];
...
const TrainerProfile: React.FC = () => {
  return (
    <div className="py-10 px-5 bg-gray-100">
      <h1 className="text-3xl font-bold text-center text-indigo-600 mb-8">Our Trainers</h1>
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {trainers.map((trainer, index) => (
          ...
          >
            ...
            <div>
              <h3 className="font-medium text-gray-700 mb-2">Client Reviews:</h3>
